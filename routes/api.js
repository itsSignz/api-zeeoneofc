...
var creatorList = ['@SyariefGans','@SyariefGans','@Syarieff','@SyariefGans', '@SyariefGans','@Syariefganteng','@SyariefGans'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'syariefgans') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'syariefgans') return res.json(loghandler.invalidKey)
